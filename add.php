...
unset($_SESSION['glb']);
unset($_SESSION['img']);
require'webserver/connectSQL.php';
...
$path ="upload/gltf/glb/".$file_glb;
// var_dump($path);die();
$link ="/SEO4-Nhom14.2/upload/gltf/glb/".$file_glb;
...
// var_dump($path);die();
$linkimg ="/SEO4-Nhom14.2/upload/img/".$file_img;
//upload nội dung file từ đường dẫn tạm vào đường dẫn vừa tạo:
...
header("location: webserver/listFile.php");
